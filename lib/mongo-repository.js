(function() {
  ...
  module.exports = {
    ...
    getPuzzleByTopicNames: function(startTopicName, endTopicName, callback) {
    ...
    getPuzzlesByUserId: function(userId, sortType, page, pageSize, callback) {
      var options, sort;
